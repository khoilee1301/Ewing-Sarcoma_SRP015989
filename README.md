...
In contrast, two downregulated genes—GABRA4 and SYNPR—were associated with neuronal or lineage-inappropriate transcriptional programs. GABRA4 encodes a subunit of the GABAA_A​ receptor, a central component of inhibitory neurotransmission, while SYNPR is involved in synaptic vesicle organization and neurotransmitter release. Although neither gene has been directly implicated in Ewing sarcoma, these tumors are known to exhibit neuroectoderm-like features and aberrantly express neural or non-mesenchymal markers. The reduced expression of GABRA4 and SYNPR following EWS–FLI knockdown may therefore reflect attenuation of aberrant neural-like transcriptional programs maintained by the fusion oncogene. Further studies will be required to determine whether these changes represent a broader shift in cell identity or differentiation state.

![downregulated](downregulated_gene.png)
